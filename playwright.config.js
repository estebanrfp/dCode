...
export default defineConfig({
  ...
  timeout: 300_000,
  reporter: [["list"]],
  use: { baseURL: "http://localhost:5805", trace: "on-first-retry" },
  projects: [{ name: "chromium", use: { ...devices["Desktop Chrome"] } }],
  webServer: { command: "bun tests/server.mjs", url: "http://localhost:5805/", reuseExistingServer: false, timeout: 30_000 },
})
