...
export const CONSTITUTION = {
  ...
  principles: [
    ...
    ["Presence is not signed", "The dots that say who is inside a repository ride the same ephemeral channel as the carets: nothing is written, nothing is signed, and a window that closes takes its dot with it. So presence counts windows and names nobody — a message on that channel carries no signature, and dCode will not put a name on something it cannot verify. What it does tell the room is which repository you are reading."],
